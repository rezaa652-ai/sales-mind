  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="max-w-6xl w-full mx-auto px-4 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        {/* ✅ Mobile menu with working /auth links */}
        <MobileMenu
          extraLinks={[
            { label: 'Log In', href: 'https://www.salesmind.app/auth?mode=login' },
            { label: 'Sign Up', href: 'https://www.salesmind.app/auth?mode=signup' },
          ]}
        />
      </header>
